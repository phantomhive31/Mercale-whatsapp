...
const Dashboard = () => {
  ...
  // Removed showProInstructions
  
  // Removed PIX support geo check
    ...
    <div>
      <Container maxWidth="lg" className={classes.container}>
        <Grid container spacing={3} justifyContent="flex-start">
          ...
          {/* Removed Ticketz PRO promo and registry block */}

          {/* Removed Support PIX/Donations block */}
